...
title('Salt Pond Metabolism: F_A_I_R = 0','FontName','Georgia','FontSize',16)
xticks([1 2 3 4 5 6])
...
bar(1,0)
ylabel('NEM, GPP, and ER (mmol m^-^2 d^-^1)','FontName','Georgia','FontSize',12)
title('Salt Pond Metabolism: F_A_I_R = variable','FontName','Georgia','FontSize',16)
xticks([1 2 3 4 5 6])
xticklabels({'Day 1','Night 1','Day 2', 'Night 2', 'Day 3', 'Night 3'})
legend('ER','NEM','GPP','Location','SW')
...
bar(1,0)
ylabel('NEM, GPP, and ER (mmol m^-^2 d^-^1)','FontName','Georgia','FontSize',12)
title('Salt Pond Metabolism: F_A_I_R = constant','FontName','Georgia','FontSize',16)
xticks([1 2 3 4 5 6])
xticklabels({'Day 1','Night 1','Day 2', 'Night 2', 'Day 3', 'Night 3'})
legend('ER','NEM','GPP','Location','SW')
...
hold on
ylabel('NEM, GPP, and ER (mmol m^-^2 d^-^1)','FontName','Georgia','FontSize',12)
title('South Platform Metabolism: F_A_I_R = constant','FontName','Georgia','FontSize',16)
xticks([1 2 3 4 5 6])
xticklabels({'Day 1','Night 1','Day 2', 'Night 2', 'Day 3', 'Night 3'})
legend('ER','NEM','GPP','Location','SW')
